    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/bootstrap/admin/status").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/clinical-cases/**").hasRole("PROFESOR")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/clinical-cases/**").hasRole("PROFESOR")
